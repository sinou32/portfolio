...
// Removed html2pdf for now to test basic functionality
...
const Portfolio = () => {
  ...
  const exportToPDF = () => {
    // Temporarily disabled - will implement after basic functionality works
    alert('PDF export will be implemented after backend integration');
  };
